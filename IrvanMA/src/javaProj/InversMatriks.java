...
public class InversMatriks {
  ...
  public static void main(String[] args) {
    ...
    if (determinan == 0) {
      ...
      String[][] invers = {
        {
          (adjoin[0][0] + "/" + determinan),
          (adjoin[0][1] + "/" + determinan),
          (adjoin[0][2] + "/" + determinan),
        },
        {
          (adjoin[1][0] + "/" + determinan),
          (adjoin[1][1] + "/" + determinan),
          (adjoin[1][2] + "/" + determinan),
        },
        {
          (adjoin[2][0] + "/" + determinan),
          (adjoin[2][1] + "/" + determinan),
          (adjoin[2][2] + "/" + determinan),
        },
      };
