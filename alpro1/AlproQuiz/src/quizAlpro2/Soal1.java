...
public class Soal1 
{
	public static void main(String args[])
	{
		...
		if (errorMerek == 1)
		{
			System.out.println("Error : Input merek yang anda masukkan tidak ada di database");
		...
		if (errorModel == 1)
		{
			System.out.println("Error : Input model yang anda masukkan tidak ada di database");
			System.out.println("Silahkan mengulang kembali.");
			System.out.println();
			main(null);
		}
